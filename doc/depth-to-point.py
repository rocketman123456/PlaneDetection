    ...
    while True:
        ...
        for (x, y, w, h) in faces:
            if curr_frame > 100 and curr_frame % 40 == 10:
                ...
                cv2.imwrite('./3d_output/%d/depth.jpg' % curr_frame, roi_depth_image)
                cv2.imwrite('./3d_output/%d/color.jpg' % curr_frame, roi_color_image)
                print("the mid position depth is:", depth_frame.get_distance(int(x+w/2), int(y+h/2)))
